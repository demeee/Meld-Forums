...
<div class="section clearfix">
	<table class="ms-datatable display hideTable" id="ms-datatable"
		data-url="#$.globalConfig().getContext()#/plugins/#local.rc.pluginConfig.getDirectory()#/com/meldsolutions/meldforums/remote/MeldForumsRemoteAOP.cfc?method=getConfigurationList&data&returnFormat=json">
		<thead class="headers">
		<tr>
			<th class="nosort nopad ui-state-active" data-class="nopad">&nbsp;</th>
			<th class="varWidth ui-state-active">#local.rc.mmRBF.key('name')#</th>
			<th class="minWidth ui-state-active" data-class="center">#local.rc.mmRBF.key('master')#</th>
			<th class="bitWidth ui-state-active" data-class="center">#local.rc.mmRBF.key('r')#</th>
			<th class="bitWidth ui-state-active" data-class="center">#local.rc.mmRBF.key('c')#</th>
			<th class="bitWidth ui-state-active" data-class="center">#local.rc.mmRBF.key('m')#</th>
			<th class="bitWidth ui-state-active" data-class="center">#local.rc.mmRBF.key('att')#</th>
