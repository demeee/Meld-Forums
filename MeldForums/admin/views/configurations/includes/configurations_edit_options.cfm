	...
	<div id="msTabs-Options">
		...
		<ul class="form">
			...
			<li>
				...
				<input class="text" type="text" name="configurationbean_allowattachmentextensions" id="configurationbean_allowattachmentextensions" value="#form.configurationbean_allowattachmentextensions#" size="100" maxlength="250" required="true" validate="string" message="#rc.mmRBF.key('allowedextensionslist','validation')#" />
			...
			<li class="last">
				...
				<input class="text tiny" type="text" name="configurationbean_filesizeLimit" id="configurationbean_filesizeLimit" value="#form.configurationbean_filesizeLimit#" size="20" maxlength="5" required="true" validate="number" message="#rc.mmRBF.key('filesizeLimit','validation')#" />
			</li>
		</ul
		<ul class="form">
			<fieldset>
			...
			<li>
				...
				<input class="text tiny" type="text" name="configurationbean_ImageWidthLimit" id="configurationbean_ImageWidthLimit" value="#form.configurationbean_ImageWidthLimit#" size="20" maxlength="5" required="true" validate="number" message="#rc.mmRBF.key('ImageWidthLimit','validation')#" />
			</li>
			<li class="last">
				...
				<input class="text tiny" type="text" name="configurationbean_ImageHeightLimit" id="configurationbean_ImageHeightLimit" value="#form.configurationbean_ImageHeightLimit#" size="20" maxlength="5" required="true" validate="number" message="#rc.mmRBF.key('ImageHeightLimit','validation')#" />
			</li>
			</fieldset>
		</ul>
	</div>
